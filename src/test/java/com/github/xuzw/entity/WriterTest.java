...
import com.github.xuzw.entity.api.RepositoryWriter;
...
public class WriterTest {
    public static void main(String[] args) throws Exception {
        ...
        repositoryWriter.append(new EntityBuilder().name("徐泽威").shortName("我").property("性别", "男").timestamp(System.currentTimeMillis()).build());
        repositoryWriter.append(new EntityBuilder().name("徐泽威").shortName("泽威").property("性别", "男").property("出生日期", "1991-04-01").timestamp(System.currentTimeMillis()).build());
